...
// <summary>QIG TelNumber Input InputBoxes Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Input
{
    ...
    /// <summary>
    /// QIG TelNumber Input InputBoxes Page.
    /// </summary>
    public partial class InputBoxes : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Input/inputboxes.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Input Boxes");
        }
    }
}
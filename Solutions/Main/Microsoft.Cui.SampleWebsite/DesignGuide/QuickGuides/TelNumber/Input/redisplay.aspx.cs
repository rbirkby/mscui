// <copyright file="redisplay.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG TelNumber Input Redisplay Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Input
{
    ...
    /// <summary>
    /// QIG TelNumber Input Redisplay Page.
    /// </summary>
    public partial class Redisplay : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Input/redisplay.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Redisplay Formats");
        }
    }
}
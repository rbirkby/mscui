// <copyright file="entryformat.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG TelNumber Input EntryFormat Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Input
{
    #region Using...
    ...
    /// <summary>
    /// QIG TelNumber Input EntryFormat Page.
    /// </summary>
    public partial class EntryFormat : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Input/entryformat.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Entry Format");
        }
    }
}
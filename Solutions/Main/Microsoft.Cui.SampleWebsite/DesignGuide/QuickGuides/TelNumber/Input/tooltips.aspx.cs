...
// <summary>QIG TelNumber Input ToolTips Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Input
{
    ...
    /// <summary>
    /// QIG TelNumber Input ToolTips Page.
    /// </summary>
    public partial class ToolTips : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Input/tooltips.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Tooltips");
        }
    }
}
// <copyright file="extension.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG TelNumber Display Extension Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Display
{
    ...
    /// <summary>
    /// QIG TelNumber Display Extension Page.
    /// </summary>
    public partial class Extension : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Display/extension.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Extension Number");
        }
    }
}
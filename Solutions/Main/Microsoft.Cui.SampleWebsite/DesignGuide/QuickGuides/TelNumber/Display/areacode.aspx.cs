// <copyright file="areacode.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG TelNumber Display AreaCode Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Display
{
    ...
    /// <summary>
    /// QIG TelNumber Display AreaCode Page.
    /// </summary>
    public partial class AreaCode : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Display/areacode.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Area Code");
        }
    }
}
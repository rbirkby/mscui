// <copyright file="countrycode.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG TelNumber Display CountryCode Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.TelNumber.Display
{
    ...
    /// <summary>
    /// QIG TelNumber Display CountryCode Page.
    /// </summary>
    public partial class CountryCode : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/TelNumber/Display/countrycode.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Country Code");
        }
    }
}
// <copyright file="strength.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine Attributes Strength Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.Attributes
{
    ...
    /// <summary>
    /// QIG MedicationLine Attributes Strength Page.
    /// </summary>
    public partial class Strength : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/Attributes/strength.aspx");
            Master.Attributes.Add("SubHeader1", "Attributes");
            Master.Attributes.Add("SubHeader2", "Strength");
        }
    }
}
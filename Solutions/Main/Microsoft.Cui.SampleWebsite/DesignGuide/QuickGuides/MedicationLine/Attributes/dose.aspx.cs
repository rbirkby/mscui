// <copyright file="dose.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine Attributes Dose Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.Attributes
{
    ...
    /// <summary>
    /// QIG MedicationLine Attributes Dose Page.
    /// </summary>
    public partial class Dose : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/Attributes/dose.aspx");
            Master.Attributes.Add("SubHeader1", "Attributes");
            Master.Attributes.Add("SubHeader2", "Dose");
        }
    }
}
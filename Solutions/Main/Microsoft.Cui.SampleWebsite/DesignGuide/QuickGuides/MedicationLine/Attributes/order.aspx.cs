...
// <summary>QIG MedicationLine Attributes Order Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.Attributes
{
    ...
    /// <summary>
    /// QIG MedicationLine Attributes Order Page.
    /// </summary>
    public partial class Order : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/Attributes/order.aspx");
            Master.Attributes.Add("SubHeader1", "Attributes");
            Master.Attributes.Add("SubHeader2", "Attribute Order");
        }
    }
}
// <copyright file="symbols.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine FormatLayout Symbols Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.FormatLayout
{
    ...
    /// <summary>
    /// QIG MedicationLine FormatLayout Symbols Page.
    /// </summary>
    public partial class Symbols : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/FormatLayout/symbols.aspx");
            Master.Attributes.Add("SubHeader1", "Format and Layout");
            Master.Attributes.Add("SubHeader2", "Symbols");
        }
    }
}
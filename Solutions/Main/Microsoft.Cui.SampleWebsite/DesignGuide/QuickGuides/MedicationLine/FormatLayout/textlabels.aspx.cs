// <copyright file="textlabels.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine FormatLayout TextLabels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.FormatLayout
{
    ...
    /// <summary>
    /// QIG MedicationLine FormatLayout TextLabels Page.
    /// </summary>
    public partial class TextLabels : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/FormatLayout/textlabels.aspx");
            Master.Attributes.Add("SubHeader1", "Format and Layout");
            Master.Attributes.Add("SubHeader2", "Text Labels");
        }
    }
}
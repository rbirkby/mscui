// <copyright file="linespacing.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine FormatLayout LineSpacing Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.FormatLayout
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationLine FormatLayout LineSpacing Page.
    /// </summary>
    public partial class LineSpacing : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/FormatLayout/linespacing.aspx");
            Master.Attributes.Add("SubHeader1", "Format and Layout");
            Master.Attributes.Add("SubHeader2", "Line Spacing");
        }
    }
}
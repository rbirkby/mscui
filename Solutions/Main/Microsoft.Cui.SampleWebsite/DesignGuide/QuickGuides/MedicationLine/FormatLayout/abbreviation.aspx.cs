// <copyright file="abbreviation.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine FormatLayout Abbreviation Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.FormatLayout
{
    ...
    /// <summary>
    /// QIG MedicationLine FormatLayout Abbreviation Page.
    /// </summary>
    public partial class Abbreviation : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/FormatLayout/abbreviation.aspx");
            Master.Attributes.Add("SubHeader1", "Format and Layout");
            Master.Attributes.Add("SubHeader2", "Abbreviation");
        }
    }
}
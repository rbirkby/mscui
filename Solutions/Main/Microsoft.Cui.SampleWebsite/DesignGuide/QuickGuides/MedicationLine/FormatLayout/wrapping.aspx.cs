// <copyright file="wrapping.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationLine FormatLayout Wrapping Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationLine.FormatLayout
{
    ...
    /// <summary>
    /// QIG MedicationLine FormatLayout Wrapping Page.
    /// </summary>
    public partial class Wrapping : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationLine/FormatLayout/wrapping.aspx");
            Master.Attributes.Add("SubHeader1", "Format and Layout");
            Master.Attributes.Add("SubHeader2", "Wrapping");
        }
    }
}
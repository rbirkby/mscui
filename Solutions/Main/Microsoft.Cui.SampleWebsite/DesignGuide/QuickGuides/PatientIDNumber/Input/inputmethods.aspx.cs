...
// <summary>QIG PatientIDNumber Input InputMethods Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientIDNumber.Input
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientIDNumber Input InputMethods Page.
    /// </summary>
    public partial class InputMethods : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientIDNumber/Input/inputmethods.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Input Methods");
        }
    }
}
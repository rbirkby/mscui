// <copyright file="allergies.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Zone2 Collapsed Allergies Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2.Collapsed
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Collapsed Allergies Page.
    /// </summary>
    public partial class Allergies : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/Collapsed/allergies.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Collapsed Contents - Allergy Propensity");
        }
    }
}
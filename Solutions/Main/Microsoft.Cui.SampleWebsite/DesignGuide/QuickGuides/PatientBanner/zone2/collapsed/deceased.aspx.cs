// <copyright file="deceased.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Zone2 Collapsed Deceased Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2.Collapsed
{
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Collapsed Deceased Page.
    /// </summary>
    public partial class Deceased : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/Collapsed/deceased.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Collapsed Contents - Deceased");
        }
    }
}
// <copyright file="collapsed.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Zone2 Collapsed Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Collapsed Page.
    /// </summary>
    public partial class CollapsedPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/collapsed.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Collapsed Contents");
        }
    }
}
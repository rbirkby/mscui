...
// <summary>QIG PatientBanner Zone2 Labels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2
{
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Labels Page.
    /// </summary>
    public partial class LabelsPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/labels.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Labels");
        }
    }
}
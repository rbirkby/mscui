// <copyright file="allergyicons.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Zone2 Labels AllergyIcons Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2.Labels
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Labels AllergyIcons Page.
    /// </summary>
    public partial class AllergyIcons : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/Labels/allergyicons.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Labels - Allergy Icons");
        }
    }
}
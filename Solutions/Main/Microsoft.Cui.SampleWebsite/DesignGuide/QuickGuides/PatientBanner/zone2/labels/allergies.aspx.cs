...
// <summary>QIG PatientBanner Zone2 Labels Allergies Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone2.Labels
{
    ...
    /// <summary>
    /// QIG PatientBanner Zone2 Labels Allergies Page.
    /// </summary>
    public partial class Allergies : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone2/Labels/allergies.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 2");
            Master.Attributes.Add("SubHeader2", "Labels - Allergy Propensity");
        }
    }
}
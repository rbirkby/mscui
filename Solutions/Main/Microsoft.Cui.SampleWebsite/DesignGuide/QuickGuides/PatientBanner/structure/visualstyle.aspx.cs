// <copyright file="visualstyle.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Structure VisualStyle Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Structure
{
    ...
    /// <summary>
    /// QIG PatientBanner Structure VisualStyle Page.
    /// </summary>
    public partial class VisualStyle : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Structure/visualstyle.aspx");
            Master.Attributes.Add("SubHeader1", "Structure");
            Master.Attributes.Add("SubHeader2", "Visual Style");
        }
    }
}
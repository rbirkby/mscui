// <copyright file="context.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Structure Context Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Structure
{
    ...
    /// <summary>
    /// QIG PatientBanner Structure Context Page.
    /// </summary>
    public partial class Context : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Structure/context.aspx");
            Master.Attributes.Add("SubHeader1", "Structure");
            Master.Attributes.Add("SubHeader2", "Application Context");
        }
    }
}
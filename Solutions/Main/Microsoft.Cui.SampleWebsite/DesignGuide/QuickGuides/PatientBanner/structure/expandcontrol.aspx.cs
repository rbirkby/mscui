// <copyright file="expandcontrol.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Structure ExpandControl Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Structure
{
    ...
    /// <summary>
    /// QIG PatientBanner Structure ExpandControl Page.
    /// </summary>
    public partial class ExpandControl : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Structure/expandcontrol.aspx");
            Master.Attributes.Add("SubHeader1", "Structure");
            Master.Attributes.Add("SubHeader2", "Expand / Collapse");
        }
    }
}
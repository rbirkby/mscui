// <copyright file="datalabelformats.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Structure DataLabelFormats Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Structure
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientBanner Structure DataLabelFormats Page.
    /// </summary>
    public partial class DataLabelFormats : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Structure/datalabelformats.aspx");
            Master.Attributes.Add("SubHeader1", "Structure");
            Master.Attributes.Add("SubHeader2", "Data and Label Formats");
        }
    }
}
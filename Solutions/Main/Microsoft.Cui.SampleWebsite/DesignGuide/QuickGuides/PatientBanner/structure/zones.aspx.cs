// <copyright file="zones.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Structure Zones Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Structure
{
    ...
    /// <summary>
    /// QIG PatientBanner Structure Zones Page.
    /// </summary>
    public partial class Zones : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Structure/zones.aspx");
            Master.Attributes.Add("SubHeader1", "Structure");
            Master.Attributes.Add("SubHeader2", "Zones");
        }
    }
}
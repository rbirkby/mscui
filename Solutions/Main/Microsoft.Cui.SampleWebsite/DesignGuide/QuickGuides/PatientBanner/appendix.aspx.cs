// <copyright file="appendix.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Appendix Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner
{
    ...
    /// <summary>
    /// QIG PatientBanner Appendix Page.
    /// </summary>
    public partial class Appendix : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/appendix.aspx");
            Master.Attributes.Add("SubHeader1", "Appendix");            
        }
    }
}
// <copyright file="age.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientBanner Zone1 Contents Age Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone1.Contents
{
    ...
    /// <summary>
    /// QIG PatientBanner Zone1 Contents Age Page.
    /// </summary>
    public partial class Age : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone1/Contents/age.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 1");
            Master.Attributes.Add("SubHeader2", "Contents - Age");
        }
    }
}
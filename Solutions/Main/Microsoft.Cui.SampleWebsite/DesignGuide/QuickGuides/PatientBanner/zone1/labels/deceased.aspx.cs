...
// <summary>QIG PatientBanner Zone1 Labels deceased Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientBanner.Zone1.Labels
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientBanner Zone1 Labels deceased Page.
    /// </summary>
    public partial class Deceased : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientBanner/Zone1/Labels/deceased.aspx");
            Master.Attributes.Add("SubHeader1", "Zone 1");
            Master.Attributes.Add("SubHeader2", "Labels - Deceased");
        }
    }
}
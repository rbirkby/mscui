// <copyright file="reopen.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe TemplatePrescriptions SelectionTrail ReOpen Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.TemplatePrescriptions.SelectionTrail
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe TemplatePrescriptions SelectionTrail ReOpen Page.
    /// </summary>
    public partial class ReOpen : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/TemplatePrescriptions/selectiontrail/reopen.aspx");
            Master.Attributes.Add("SubHeader1", "Template Prescriptions");
            Master.Attributes.Add("SubHeader2", "Selection Trail - Re-Open");
        }
    }
}
// <copyright file="layout.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe TemplatePrescriptions Layout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.TemplatePrescriptions
{
    ...
    /// <summary>
    /// QIG SearchPrescribe TemplatePrescriptions Layout Page.
    /// </summary>
    public partial class Layout : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/TemplatePrescriptions/layout.aspx");
            Master.Attributes.Add("SubHeader1", "Template Prescriptions");
            Master.Attributes.Add("SubHeader2", "Layout");
        }
    }
}
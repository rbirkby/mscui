// <copyright file="display.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe TemplatePrescriptions Display Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.TemplatePrescriptions
{
    ...
    /// <summary>
    /// QIG SearchPrescribe TemplatePrescriptions Display Page.
    /// </summary>
    public partial class Display : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/TemplatePrescriptions/display.aspx");
            Master.Attributes.Add("SubHeader1", "Template Prescriptions");
            Master.Attributes.Add("SubHeader2", "Display");
        }
    }
}
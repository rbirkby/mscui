// <copyright file="defaultfields.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DetailedForms DefaultFields Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DetailedForms
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DetailedForms DefaultFields Page. 
    /// </summary>
    public partial class DefaultFields : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DetailedForms/defaultfields.aspx");
            Master.Attributes.Add("SubHeader1", "Detailed Forms");
            Master.Attributes.Add("SubHeader2", "Default Fields");
        }
    }
}

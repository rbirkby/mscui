...
// <summary>QIG SearchPrescribe PreviewAuthorise Preview Interaction Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.PreviewAuthorise.Preview
{
    ...
    /// <summary>
    /// QIG SearchPrescribe PreviewAuthorise Preview Interaction Page. 
    /// </summary>
    public partial class Interaction : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/PreviewAuthorise/Preview/interaction.aspx");
            Master.Attributes.Add("SubHeader1", "Preview and Authorise");
            Master.Attributes.Add("SubHeader2", "Preview - Interaction");
        }
    }
}
...
// <summary>QIG SearchPrescribe PreviewAuthorise Preview Control Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.PreviewAuthorise.Preview
{
    ...
    /// <summary>
    /// QIG SearchPrescribe PreviewAuthorise Preview Control Page. 
    /// </summary>
    public partial class Control : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/PreviewAuthorise/Preview/control.aspx");
            Master.Attributes.Add("SubHeader1", "Preview and Authorise");
            Master.Attributes.Add("SubHeader2", "Preview - Controls");
        }
    }
}
// <copyright file="dimensions.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// </copyright> 
// <date>06-May-2010</date>
// <summary>QIG SearchPrescribe SentenceLayout Dimensions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.SentenceLayout
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe SentenceLayout Dimensions Page.
    /// </summary>
    public partial class Dimensions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/SentenceLayout/dimensions.aspx");
            Master.Attributes.Add("SubHeader1", "Sentence Layout");
            Master.Attributes.Add("SubHeader2", "Dimensions");
        }
    }
}
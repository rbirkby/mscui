...
// <summary>QIG SearchPrescribe SentenceLayout Format Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.SentenceLayout
{
    ...
    /// <summary>
    /// QIG SearchPrescribe SentenceLayout Format Page.
    /// </summary>
    public partial class Format : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/SentenceLayout/format.aspx");
            Master.Attributes.Add("SubHeader1", "Sentence Layout");
            Master.Attributes.Add("SubHeader2", "Format");
        }
    }
}
// <copyright file="purpose.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe SentenceLayout Purpose Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.SentenceLayout
{
    ...
    /// <summary>
    /// QIG SearchPrescribe SentenceLayout Purpose Page.
    /// </summary>
    public partial class Purpose : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/SentenceLayout/purpose.aspx");
            Master.Attributes.Add("SubHeader1", "Sentence Layout");
            Master.Attributes.Add("SubHeader2", "Purpose");
        }
    }
}
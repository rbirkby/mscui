// <copyright file="listheight.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch ListHeight Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch ListHeight Page.
    /// </summary>
    public partial class ListHeightPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/listheight.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "List Height");
        }
    }
}
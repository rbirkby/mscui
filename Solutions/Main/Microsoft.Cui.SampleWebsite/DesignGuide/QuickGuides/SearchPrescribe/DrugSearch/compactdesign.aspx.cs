// <copyright file="compactdesign.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch CompactDesign Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch CompactDesign Page.
    /// </summary>
    public partial class CompactDesign : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/compactdesign.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Compact Design");
        }
    }
}
// <copyright file="spellsynonyms.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Matching SpellSynonyms Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Matching
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Matching SpellSynonyms Page.
    /// </summary>
    public partial class SpellSynonyms : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Matching/spellsynonyms.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Matching - Spelling and Synonyms");
        }
    }
}
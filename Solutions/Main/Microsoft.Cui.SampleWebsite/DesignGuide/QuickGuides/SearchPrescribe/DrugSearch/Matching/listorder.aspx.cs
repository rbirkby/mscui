// <copyright file="listorder.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Matching ListOrder Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Matching
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Matching ListOrder Page.
    /// </summary>
    public partial class ListOrder : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Matching/listorder.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Matching - List Order");
        }
    }
}
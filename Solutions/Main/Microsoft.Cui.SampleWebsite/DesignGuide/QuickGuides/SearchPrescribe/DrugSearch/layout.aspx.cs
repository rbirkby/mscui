...
// <summary>QIG SearchPrescribe DrugSearch Layout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Layout Page.
    /// </summary>
    public partial class Layout : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/layout.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Control Layout");
        }
    }
}
// <copyright file="characters.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Progressive Characters Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Progressive
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Progressive Characters Page.
    /// </summary>
    public partial class Characters : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Progressive/characters.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Progressive Search - Minimum Characters");
        }
    }
}
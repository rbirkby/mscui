// <copyright file="progressive.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Progressive Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Progressive Page.
    /// </summary>
    public partial class ProgressivePage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/progressive.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Progressive Search");
        }
    }
}
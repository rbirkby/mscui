// <copyright file="showall.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch ListHeight ShowAll Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.ListHeight
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch ListHeight ShowAll Page.
    /// </summary>
    public partial class ShowAll : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/ListHeight/showall.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "List Height - Show All");
        }
    }
}
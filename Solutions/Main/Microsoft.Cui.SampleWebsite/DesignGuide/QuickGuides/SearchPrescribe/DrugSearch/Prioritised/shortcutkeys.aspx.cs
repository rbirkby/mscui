// <copyright file="shortcutkeys.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Prioritised ShortcutKeys Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Prioritised
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Prioritised ShortcutKeys Page.
    /// </summary>
    public partial class ShortcutKeys : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Prioritised/shortcutkeys.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Prioritised Results - Shortcut Keys");
        }
    }
}
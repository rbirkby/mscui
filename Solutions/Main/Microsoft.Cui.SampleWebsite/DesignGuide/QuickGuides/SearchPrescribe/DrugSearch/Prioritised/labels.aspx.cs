// <copyright file="labels.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Prioritised Labels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Prioritised
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Prioritised Labels Page.
    /// </summary>
    public partial class Labels : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Prioritised/labels.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Prioritised Results - Labels");
        }
    }
}
// <copyright file="prioritised.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Prioritised Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Prioritised Page.
    /// </summary>
    public partial class PrioritisedPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/prioritised.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Prioritised Results");
        }
    }
}
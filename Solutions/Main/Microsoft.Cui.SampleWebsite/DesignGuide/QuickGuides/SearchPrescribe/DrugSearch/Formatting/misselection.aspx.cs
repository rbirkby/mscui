// <copyright file="misselection.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Formatting MisSelection Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Formatting
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Formatting MisSelection Page.
    /// </summary>
    public partial class MisSelection : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Formatting/misselection.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Formatting - Mis-Selection Warnings");
        }
    }
}
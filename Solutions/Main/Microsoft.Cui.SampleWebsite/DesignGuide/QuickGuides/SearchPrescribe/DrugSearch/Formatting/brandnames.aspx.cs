// <copyright file="brandnames.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Formatting BrandNames Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Formatting
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Formatting BrandNames Page.
    /// </summary>
    public partial class BrandNames : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Formatting/brandnames.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Formatting - Brand Names");
        }
    }
}
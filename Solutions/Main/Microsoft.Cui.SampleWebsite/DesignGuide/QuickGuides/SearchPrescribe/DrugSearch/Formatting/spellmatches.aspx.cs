// <copyright file="spellmatches.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe DrugSearch Formatting SpellMatches Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.DrugSearch.Formatting
{
    ...
    /// <summary>
    /// QIG SearchPrescribe DrugSearch Formatting SpellMatches Page.
    /// </summary>
    public partial class SpellMatches : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/DrugSearch/Formatting/spellmatches.aspx");
            Master.Attributes.Add("SubHeader1", "Drug Search");
            Master.Attributes.Add("SubHeader2", "Formatting - Spelling Matches");
        }
    }
}
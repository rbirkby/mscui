// <copyright file="appwindow.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe Context AppWindow Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Context
{
    ...
    /// <summary>
    /// QIG SearchPrescribe Context AppWindow Page.
    /// </summary>
    public partial class AppWindow : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Context/appwindow.aspx");
            Master.Attributes.Add("SubHeader1", "Context");
            Master.Attributes.Add("SubHeader2", "Application Window");
        }
    }
}
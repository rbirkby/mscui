// <copyright file="simviews.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe Context SimViews Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Context
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe Context SimViews Page.
    /// </summary>
    public partial class SimViews : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Context/simviews.aspx");
            Master.Attributes.Add("SubHeader1", "Context");
            Master.Attributes.Add("SubHeader2", "Simultaneous Views");
        }
    }
}
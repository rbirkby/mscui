// <copyright file="drugname.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe PrescriptionForms DrugName Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.PrescriptionForms
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe PrescriptionForms DrugName Page. 
    /// </summary>
    public partial class DrugName : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/PrescriptionForms/drugname.aspx");
            Master.Attributes.Add("SubHeader1", "Prescription Forms");
            Master.Attributes.Add("SubHeader2", "Drug Name");
        }
    }
}
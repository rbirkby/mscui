// <copyright file="structure.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe PrescriptionForms Structure Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.PrescriptionForms
{
    ...
    /// <summary>
    /// QIG SearchPrescribe PrescriptionForms Structure Page. 
    /// </summary>
    public partial class Structure : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/PrescriptionForms/structure.aspx");
            Master.Attributes.Add("SubHeader1", "Prescription Forms");
            Master.Attributes.Add("SubHeader2", "Structure");
        }
    }
}
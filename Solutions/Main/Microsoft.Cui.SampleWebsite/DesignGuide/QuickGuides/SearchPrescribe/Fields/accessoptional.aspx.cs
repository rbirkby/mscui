// <copyright file="accessoptional.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe Fields AccessOptional Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Fields
{
    ...
    /// <summary>
    /// QIG SearchPrescribe Fields AccessOptional Page. 
    /// </summary>
    public partial class AccessOptional : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Fields/accessoptional.aspx");
            Master.Attributes.Add("SubHeader1", "Fields");
            Master.Attributes.Add("SubHeader2", "Access Optional");
        }
    }
}
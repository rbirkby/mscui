// <copyright file="promotedoptional.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe Fields PromotedOptional Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Fields
{
    ...
    /// <summary>
    /// QIG SearchPrescribe Fields PromotedOptional Page. 
    /// </summary>
    public partial class PromotedOptional : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Fields/promotedoptional.aspx");
            Master.Attributes.Add("SubHeader1", "Fields");
            Master.Attributes.Add("SubHeader2", "Promoted Optional");
        }
    }
}
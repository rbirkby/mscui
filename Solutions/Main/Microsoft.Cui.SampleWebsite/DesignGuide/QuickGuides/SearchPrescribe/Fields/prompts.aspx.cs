...
// <summary>QIG SearchPrescribe Fields Prompts Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Fields
{
    ...
    /// <summary>
    /// QIG SearchPrescribe Fields Prompts Page. 
    /// </summary>
    public partial class Prompts : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Fields/prompts.aspx");
            Master.Attributes.Add("SubHeader1", "Fields");
            Master.Attributes.Add("SubHeader2", "Prompts");
        }
    }
}
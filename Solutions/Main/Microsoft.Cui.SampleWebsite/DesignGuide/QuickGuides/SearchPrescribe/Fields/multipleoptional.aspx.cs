// <copyright file="multipleoptional.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe Fields MultipleOptional Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.Fields
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe Fields MultipleOptional Page. 
    /// </summary>
    public partial class MultipleOptional : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/Fields/multipleoptional.aspx");
            Master.Attributes.Add("SubHeader1", "Fields");
            Master.Attributes.Add("SubHeader2", "Multiple Optional");
        }
    }
}
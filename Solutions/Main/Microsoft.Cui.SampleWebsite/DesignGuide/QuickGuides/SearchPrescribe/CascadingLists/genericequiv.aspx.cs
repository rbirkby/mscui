// <copyright file="genericequiv.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName CascadingLists GenericEquiv Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.CascadingLists
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientName CascadingLists GenericEquiv Page.
    /// </summary>
    public partial class GenericEquiv : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/CascadingLists/genericequiv.aspx");
            Master.Attributes.Add("SubHeader1", "Cascading Lists");
            Master.Attributes.Add("SubHeader2", "Generic Equivalents");
        }
    }
}
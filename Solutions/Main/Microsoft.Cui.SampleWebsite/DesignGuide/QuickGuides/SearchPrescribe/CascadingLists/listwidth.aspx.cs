// <copyright file="listwidth.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe CascadingLists ListWidth Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.CascadingLists
{
    ...
    /// <summary>
    /// QIG SearchPrescribe CascadingLists ListWidth Page.
    /// </summary>
    public partial class ListWidth : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/CascadingLists/listwidth.aspx");
            Master.Attributes.Add("SubHeader1", "Cascading Lists");
            Master.Attributes.Add("SubHeader2", "Results List Width");
        }
    }
}
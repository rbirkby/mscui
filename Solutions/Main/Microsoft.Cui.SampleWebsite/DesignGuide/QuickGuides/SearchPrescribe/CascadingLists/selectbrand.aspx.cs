// <copyright file="selectbrand.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe CascadingLists SelectBrand Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.CascadingLists
{
    ...
    /// <summary>
    /// QIG SearchPrescribe CascadingLists SelectBrand Page.
    /// </summary>
    public partial class SelectBrand : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/CascadingLists/selectbrand.aspx");
            Master.Attributes.Add("SubHeader1", "Cascading Lists");
            Master.Attributes.Add("SubHeader2", "Selecting Brand");
        }
    }
}
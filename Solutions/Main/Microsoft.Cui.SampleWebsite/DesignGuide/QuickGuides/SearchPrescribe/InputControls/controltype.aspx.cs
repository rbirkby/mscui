// <copyright file="controltype.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe InputControls ControlType Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls
{
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls ControlType Page. 
    /// </summary>
    public partial class ControlType : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/controltype.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Control Type");
        }
    }
}
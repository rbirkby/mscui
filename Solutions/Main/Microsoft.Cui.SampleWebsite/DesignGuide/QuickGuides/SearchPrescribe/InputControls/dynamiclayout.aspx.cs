// <copyright file="dynamiclayout.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe InputControls DynamicLayout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls
{
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls DynamicLayout Page. 
    /// </summary>
    public partial class DynamicLayout : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/dynamiclayout.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Dynamic Layout");
        }
    }
}
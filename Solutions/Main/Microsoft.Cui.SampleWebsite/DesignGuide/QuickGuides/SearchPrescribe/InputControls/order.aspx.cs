...
// <summary>QIG SearchPrescribe InputControls Order Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls
{
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls Order Page. 
    /// </summary>
    public partial class Order : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/order.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Order");
        }
    }
}
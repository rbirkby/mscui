// <copyright file="datetime.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe InputControls DateTime Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls
{
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls DateTime Page. 
    /// </summary>
    public partial class DateTime : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/datetime.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Date and Time");
        }
    }
}
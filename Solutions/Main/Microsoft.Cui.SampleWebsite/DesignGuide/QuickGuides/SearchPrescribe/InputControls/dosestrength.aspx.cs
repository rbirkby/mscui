// <copyright file="dosestrength.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe InputControls DoseStrength Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls
{
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls DoseStrength Page. 
    /// </summary>
    public partial class DoseStrength : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/dosestrength.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Dose and Strength");
        }
    }
}
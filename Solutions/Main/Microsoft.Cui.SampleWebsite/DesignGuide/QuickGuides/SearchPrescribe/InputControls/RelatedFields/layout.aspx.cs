...
// <summary>QIG SearchPrescribe InputControls RelatedFields Layout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.InputControls.RelatedFields
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe InputControls RelatedFields Layout Page. 
    /// </summary>
    public partial class Layout : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/InputControls/RelatedFields/layout.aspx");
            Master.Attributes.Add("SubHeader1", "Input Controls");
            Master.Attributes.Add("SubHeader2", "Related Fields - Layout");
        }
    }
}
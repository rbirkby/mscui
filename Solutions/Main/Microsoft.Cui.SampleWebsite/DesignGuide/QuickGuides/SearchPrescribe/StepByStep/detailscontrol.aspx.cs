// <copyright file="detailscontrol.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe StepByStep DetailsControl Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.StepByStep
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe StepByStep DetailsControl Page.
    /// </summary>
    public partial class DetailsControl : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/StepByStep/detailscontrol.aspx");
            Master.Attributes.Add("SubHeader1", "Step by Step");
            Master.Attributes.Add("SubHeader2", "Details Control");
        }
    }
}
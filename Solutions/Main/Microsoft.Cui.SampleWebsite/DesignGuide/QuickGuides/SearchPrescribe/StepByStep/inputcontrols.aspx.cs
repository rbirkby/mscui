// <copyright file="inputcontrols.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe StepByStep InputControls Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.StepByStep
{
    ...
    /// <summary>
    /// QIG SearchPrescribe StepByStep InputControls Page.
    /// </summary>
    public partial class InputControls : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/StepByStep/inputcontrols.aspx");
            Master.Attributes.Add("SubHeader1", "Step by Step");
            Master.Attributes.Add("SubHeader2", "Input Controls");
        }
    }
}
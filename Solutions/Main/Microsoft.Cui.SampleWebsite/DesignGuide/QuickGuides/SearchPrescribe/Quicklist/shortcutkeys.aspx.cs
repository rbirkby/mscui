...
// <summary>QIG SearchPrescribe QuickList ShortcutKeys Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.QuickList
{
    ...
    /// <summary>
    /// QIG SearchPrescribe QuickList ShortcutKeys Page.
    /// </summary>
    public partial class ShortcutKeys : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/QuickList/shortcutkeys.aspx");           
            Master.Attributes.Add("SubHeader1", "Quick List");
            Master.Attributes.Add("SubHeader2", "Shortcut Keys");
        }
    }
}
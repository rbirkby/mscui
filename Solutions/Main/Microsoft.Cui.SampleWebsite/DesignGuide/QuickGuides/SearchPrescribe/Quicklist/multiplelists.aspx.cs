// <copyright file="multiplelists.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG SearchPrescribe QuickList MultipleLists Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.SearchPrescribe.QuickList
{
    #region Using...
    ...
    /// <summary>
    /// QIG SearchPrescribe QuickList MultipleLists Page.
    /// </summary>
    public partial class MultipleLists : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/SearchPrescribe/QuickList/multiplelists.aspx");
            Master.Attributes.Add("SubHeader1", "Quick List");
            Master.Attributes.Add("SubHeader2", "Multiple Quick Lists");
        }
    }
}
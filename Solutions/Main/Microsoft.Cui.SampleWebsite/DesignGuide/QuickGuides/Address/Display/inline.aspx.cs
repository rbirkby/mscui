...
// <summary>QIG Address Display InLine Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Display
{
    ...
    /// <summary>
    /// QIG Address Display InLine Page.
    /// </summary>
    public partial class InLine : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Display/inline.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "In-Line"); 
        }
    }
}
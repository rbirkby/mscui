...
// <summary>Address Display QIG Checklist Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Display
{
    #region Using...
    ...
    /// <summary>
    /// Address Display QIG Checklist Page.
    /// </summary>
    public partial class General : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Display/general.aspx");

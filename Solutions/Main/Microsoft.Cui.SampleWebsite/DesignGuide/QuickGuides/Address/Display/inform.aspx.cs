...
// <summary>QIG Address Display Inform Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Display
{
    ...
    /// <summary>
    /// QIG Address Display Inform Page.
    /// </summary>
    public partial class InForm : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Display/inform.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "In-Form"); 
        }
    }
}
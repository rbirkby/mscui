...
// <summary>QIG Address Input NonUKInput Layout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    ...
    /// <summary>
    /// QIG Address Input NonUKInput Layout Page.
    /// </summary>
    public partial class Layout : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/layout.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Layout"); 
        }
    }
}
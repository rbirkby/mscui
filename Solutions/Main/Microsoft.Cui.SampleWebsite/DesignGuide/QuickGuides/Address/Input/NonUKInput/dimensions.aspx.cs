...
// <summary>QIG Address Input NonUKInput Dimensions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    ...
    /// <summary>
    /// QIG Address Input NonUKInput Dimensions Page.
    /// </summary>
    public partial class Dimensions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/dimensions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Dimensions"); 
        }
    }
}
...
// <summary>QIG Address Input NonUKInput Labels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    ...
    /// <summary>
    /// QIG Address Input NonUKInput Labels Page.
    /// </summary>
    public partial class Labels : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/labels.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Labels"); 
        }
    }
}
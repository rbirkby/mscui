// <copyright file="country.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input NonUKInput Country Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    ...
    /// <summary>
    /// QIG Address Input NonUKInput Country Page.
    /// </summary>
    public partial class Country : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/country.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Country"); 
        }
    }
}
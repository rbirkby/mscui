// <copyright file="inputmethods.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input NonUKInput InputMethods Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    #region Using...
    ...
    /// <summary>
    /// QIG Address Input NonUKInput InputMethods Page.
    /// </summary>
    public partial class InputMethods : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/inputmethods.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Input Methods"); 
        }
    }
}
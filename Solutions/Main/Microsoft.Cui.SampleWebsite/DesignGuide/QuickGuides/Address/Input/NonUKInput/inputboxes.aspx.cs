// <copyright file="inputboxes.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input NonUKInput InputBoxes Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.NonUKInput
{
    ...
    /// <summary>
    /// QIG Address Input NonUKInput InputBoxes Page.
    /// </summary>
    public partial class InputBoxes : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/NonUKInput/inputboxes.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input - Input Boxes"); 
        }
    }
}
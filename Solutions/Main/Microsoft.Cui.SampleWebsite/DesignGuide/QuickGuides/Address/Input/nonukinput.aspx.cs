// <copyright file="nonukinput.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input NonUKInput Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input
{
    #region Using...
    ...
    /// <summary>
    /// QIG Address Input NonUKInput Page.
    /// </summary>
    public partial class NonUkInputPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/nonukinput.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Non-UK Address Input"); 
        }
    }
}
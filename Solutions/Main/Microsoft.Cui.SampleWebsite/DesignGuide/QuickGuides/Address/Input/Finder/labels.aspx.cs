...
// <summary>QIG Address Input Finder Labels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    ...
    /// <summary>
    /// QIG Address Input Finder Labels Page.
    /// </summary>
    public partial class Labels : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/labels.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Labels"); 
        }
    }
}
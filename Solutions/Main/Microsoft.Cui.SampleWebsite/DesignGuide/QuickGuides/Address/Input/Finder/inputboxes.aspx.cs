...
// <summary>QIG Address Input Finder InputBoxes Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    ...
    /// <summary>
    /// QIG Address Input Finder InputBoxes Page.
    /// </summary>
    public partial class InputBoxes : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/inputboxes.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Input Boxes"); 
        }
    }
}
...
// <summary>QIG Address Input Finder InputMethods Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    #region Using...
    ...
    /// <summary>
    /// QIG Address Input Finder InputMethods Page.
    /// </summary>
    public partial class InputMethods : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/inputmethods.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Input Methods"); 
        }
    }
}
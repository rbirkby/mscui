...
// <summary>QIG Address Input Finder Layout Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    ...
    /// <summary>
    /// QIG Address Input Finder Layout Page.
    /// </summary>
    public partial class Layout : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/layout.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Layout"); 
        }
    }
}
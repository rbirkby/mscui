// <copyright file="findaddress.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input Finder FindAddress Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    ...
    /// <summary>
    /// QIG Address Input Finder FindAddress Page.
    /// </summary>
    public partial class FindAddress : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/findaddress.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Find Address"); 
        }
    }
}
...
// <summary>QIG Address Input Finder Dimensions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.Finder
{
    ...
    /// <summary>
    /// QIG Address Input Finder Dimensions Page.
    /// </summary>
    public partial class Dimensions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/Finder/dimensions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder - Dimensions"); 
        }
    }
}
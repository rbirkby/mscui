// <copyright file="ukinput.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input UKInput Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input
{
    ...
    /// <summary>
    /// QIG Address Input UKInput Page.
    /// </summary>
    public partial class UKInputPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/ukinput.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input"); 
        }
    }
}
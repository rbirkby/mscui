...
// <summary>QIG Address Input Finder Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input
{
    ...
    /// <summary>
    /// QIG Address Input Finder Page.
    /// </summary>
    public partial class FinderPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/finder.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Finder"); 
        }
    }
}
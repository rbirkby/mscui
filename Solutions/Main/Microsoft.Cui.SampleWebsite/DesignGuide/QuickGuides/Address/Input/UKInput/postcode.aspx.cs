// <copyright file="postcode.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input UKInput Postcode Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    ...
    /// <summary>
    /// QIG Address Input UKInput Postcode Page.
    /// </summary>
    public partial class Postcode : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/postcode.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Postcode Finder");
        }
    }
}
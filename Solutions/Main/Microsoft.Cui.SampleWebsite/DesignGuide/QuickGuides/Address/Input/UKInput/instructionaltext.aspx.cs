// <copyright file="instructionaltext.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG Address Input UKInput InstructionalText Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    #region Using...
    ...
    /// <summary>
    /// QIG Address Input UKInput InstructionalText Page.
    /// </summary>
    public partial class InstructionalText : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/instructionaltext.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Instructional Text"); 
        }
    }
}

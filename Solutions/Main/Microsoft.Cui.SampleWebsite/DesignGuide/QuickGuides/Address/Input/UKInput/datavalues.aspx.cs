...
// <summary>QIG Address Input UKInput DataValues Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    ...
    /// <summary>
    /// QIG Address Input UKInput DataValues Page.
    /// </summary>
    public partial class DataValues : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/datavalues.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Data Values"); 
        }
    }
}
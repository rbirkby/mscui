...
// <summary>QIG Address Input UKInput InputMethods Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    ...
    /// <summary>
    /// QIG Address Input UKInput InputMethods Page.
    /// </summary>
    public partial class InputMethods : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/inputmethods.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Input Methods");
        }
    }
}
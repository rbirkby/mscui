...
// <summary>QIG Address Input UKInput Labels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    ...
    /// <summary>
    /// QIG Address Input UKInput Labels Page.
    /// </summary>
    public partial class Labels : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/labels.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Labels");
        }
    }
}
...
// <summary>QIG Address Input UKInput InputBoxes Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.Address.Input.UKInput
{
    ...
    /// <summary>
    /// QIG Address Input UKInput InputBoxes Page.
    /// </summary>
    public partial class InputBoxes : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/Address/Input/UKInput/inputboxes.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "UK Address Input - Input Boxes");
        }
    }
}
// <copyright file="statusvalues.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex  Display StatusValues Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Display
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex  Display StatusValues Page.
    /// </summary>
    public partial class StatusValues : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Display/statusvalues.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Status Values");
        }
    }
}
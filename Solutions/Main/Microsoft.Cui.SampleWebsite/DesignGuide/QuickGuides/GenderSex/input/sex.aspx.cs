// <copyright file="sex.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input Sex Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex Page.
    /// </summary>
    public partial class SexPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/sex.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex");
        }
    }
}
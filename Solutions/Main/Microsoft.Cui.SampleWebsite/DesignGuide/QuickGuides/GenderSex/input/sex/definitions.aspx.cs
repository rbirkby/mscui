...
// <summary>QIG DateTimeInput GenderSex Input Sex Definitions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Sex
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex Definitions Page.
    /// </summary>
    public partial class Definitions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Sex/definitions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex - Definitions");
        }
    }
}
...
// <summary>QIG DateTimeInput GenderSex Input Sex LabelDefault Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Sex
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex LabelDefault Page.
    /// </summary>
    public partial class LabelDefault : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Sex/labeldefault.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex - Label and Default");
        }
    }
}
...
// <summary>QIG DateTimeInput GenderSex Input Sex DropDown Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Sex
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex DropDown Page.
    /// </summary>
    public partial class DropDown : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Sex/dropdown.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex - Drop-Down List");
        }
    }
}
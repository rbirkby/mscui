...
// <summary>QIG DateTimeInput GenderSex Input Sex DataValues Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Sex
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex DataValues Page.
    /// </summary>
    public partial class DataValues : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Sex/datavalues.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex - Data Values");
        }
    }
}
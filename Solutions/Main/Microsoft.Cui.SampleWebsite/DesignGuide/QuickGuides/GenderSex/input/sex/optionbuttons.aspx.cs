...
// <summary>QIG DateTimeInput GenderSex Input Sex OptionButtons Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Sex
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Sex OptionButtons Page.
    /// </summary>
    public partial class OptionButtons : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Sex/optionbuttons.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Sex - Option Buttons");
        }
    }
}
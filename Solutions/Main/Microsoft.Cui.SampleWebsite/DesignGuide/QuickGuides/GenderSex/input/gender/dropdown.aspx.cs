// <copyright file="dropdown.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input Gender DropDown Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Gender
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Gender DropDown Page.
    /// </summary>
    public partial class DropDown : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Gender/dropdown.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Current Gender - Drop-Down List");
        }
    }
}
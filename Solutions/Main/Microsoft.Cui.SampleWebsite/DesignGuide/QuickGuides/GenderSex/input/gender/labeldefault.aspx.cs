// <copyright file="labeldefault.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input Gender LabelDefault Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Gender
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Gender LabelDefault Page.
    /// </summary>
    public partial class LabelDefault : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Gender/labeldefault.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Current Gender - Label and Default");
        }
    }
}
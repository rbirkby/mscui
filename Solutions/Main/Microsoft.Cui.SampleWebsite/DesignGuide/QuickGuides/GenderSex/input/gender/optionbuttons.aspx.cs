// <copyright file="optionbuttons.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input Gender OptionButtons Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Gender
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Gender OptionButtons Page.
    /// </summary>
    public partial class OptionButtons : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Gender/optionbuttons.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Current Gender - Option Buttons");
        }
    }
}
// <copyright file="definitions.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input Gender Definitions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Gender
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Gender Definitions Page.
    /// </summary>
    public partial class Definitions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Gender/definitions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Current Gender - Definitions");
        }
    }
}
...
// <summary>QIG DateTimeInput GenderSex Input Gender DataValues Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input.Gender
{
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input Gender DataValues Page.
    /// </summary>
    public partial class DataValues : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/Gender/datavalues.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Current Gender - Data Values");
        }
    }
}
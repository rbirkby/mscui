// <copyright file="inputdefinitions.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput GenderSex Input InputDefinitions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.GenderSex.Input
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput GenderSex Input InputDefinitions Page.
    /// </summary>
    public partial class InputDefinitions : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/GenderSex/Input/inputdefinitions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Control Definitions");
        }
    }
}
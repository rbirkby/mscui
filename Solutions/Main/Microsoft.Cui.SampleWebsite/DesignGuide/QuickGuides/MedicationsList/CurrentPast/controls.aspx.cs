// <copyright file="controls.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast Controls Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast
{
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast Controls Page.
    /// </summary>
    public partial class ControlsPage : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/controls.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Controls");
        }
    }
}
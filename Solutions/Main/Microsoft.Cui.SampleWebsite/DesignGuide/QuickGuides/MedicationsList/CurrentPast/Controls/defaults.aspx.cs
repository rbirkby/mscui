// <copyright file="defaults.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast Controls Defaults Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast.Controls
{
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast Controls Defaults Page.
    /// </summary>
    public partial class Defaults : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/Controls/defaults.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Controls - Defaults");
        }
    }
}
// <copyright file="selection.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast Controls Selection Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast.Controls
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast Controls Selection Page.
    /// </summary>
    public partial class Selection : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/Controls/selection.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Controls - Current Selection");
        }
    }
}
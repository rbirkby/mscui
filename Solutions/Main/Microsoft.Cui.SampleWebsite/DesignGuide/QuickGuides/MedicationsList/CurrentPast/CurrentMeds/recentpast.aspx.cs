// <copyright file="recentpast.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast CurrentMeds Recentpast Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast.CurrentMeds
{
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast CurrentMeds Recentpast Page.
    /// </summary>
    public partial class RecentPast : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/CurrentMeds/recentpast.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Current - Recent Past");
        }
    }
}
// <copyright file="currentmeds.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast Currentmeds Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast CurrentMeds Page.
    /// </summary>
    public partial class CurrentMedsPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/currentmeds.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Current Medications");
        }
    }
}
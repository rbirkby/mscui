// <copyright file="pastmeds.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CurrentPast Pastmeds Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.CurrentPast
{
    ...
    /// <summary>
    /// QIG MedicationsList CurrentPast Pastmeds Page.
    /// </summary>
    public partial class PastMeds : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/CurrentPast/pastmeds.aspx");
            Master.Attributes.Add("SubHeader1", "Current and Past");
            Master.Attributes.Add("SubHeader2", "Past");
        }
    }
}
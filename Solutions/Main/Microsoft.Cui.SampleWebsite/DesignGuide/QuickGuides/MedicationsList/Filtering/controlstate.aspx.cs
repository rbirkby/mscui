// <copyright file="controlstate.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Filtering ControlState Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Filtering
{
    ...
    /// <summary>
    /// QIG MedicationsList Filtering ControlState Page.
    /// </summary>
    public partial class ControlState : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Filtering/controlstate.aspx");
            Master.Attributes.Add("SubHeader1", "Filtering");
            Master.Attributes.Add("SubHeader2", "Control State");
        }
    }
}
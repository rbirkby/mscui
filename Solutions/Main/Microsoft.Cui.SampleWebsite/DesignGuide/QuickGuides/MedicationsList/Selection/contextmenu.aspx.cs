// <copyright file="contextmenu.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Selection ContextMenu Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Selection
{
    ...
    /// <summary>
    /// QIG MedicationsList Selection ContextMenu Page.
    /// </summary>
    public partial class ContextMenu : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Selection/contextmenu.aspx");
            Master.Attributes.Add("SubHeader1", "Selection");
            Master.Attributes.Add("SubHeader2", "Context Menu");
        }
    }
}
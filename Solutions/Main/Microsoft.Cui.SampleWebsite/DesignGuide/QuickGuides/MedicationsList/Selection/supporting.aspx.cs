// <copyright file="supporting.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Selection Supporting Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Selection
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList Selection Supporting Page.
    /// </summary>
    public partial class Supporting : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Selection/supporting.aspx");
            Master.Attributes.Add("SubHeader1", "Selection");
            Master.Attributes.Add("SubHeader2", "Supporting Selection");
        }
    }
}
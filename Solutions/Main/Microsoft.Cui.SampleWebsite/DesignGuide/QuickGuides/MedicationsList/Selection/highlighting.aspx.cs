// <copyright file="highlighting.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Selection Highlighting Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Selection
{
    ...
    /// <summary>
    /// QIG MedicationsList Selection Highlighting Page.
    /// </summary>
    public partial class Highlighting : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Selection/highlighting.aspx");
            Master.Attributes.Add("SubHeader1", "Selection");
            Master.Attributes.Add("SubHeader2", "Highlighting");
        }
    }
}
// <copyright file="icons.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Structure Icons Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Structure
{
    ...
    /// <summary>
    /// QIG MedicationsList Structure Icons Page.
    /// </summary>
    public partial class Icons : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Structure/icons.aspx");
            Master.Attributes.Add("SubHeader1", "Structure and Layout");
            Master.Attributes.Add("SubHeader2", "Displaying Icons");
        }
    }
}
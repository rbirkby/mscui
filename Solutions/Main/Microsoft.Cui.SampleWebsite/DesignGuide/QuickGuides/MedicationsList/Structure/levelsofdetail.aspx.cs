// <copyright file="levelsofdetail.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LevelsOfDetail Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Structure
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList LevelsOfDetail Page.
    /// </summary>
    public partial class LevelsOfDetail : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Structure/levelsofdetail.aspx");
            Master.Attributes.Add("SubHeader1", "Structure and Layout");
            Master.Attributes.Add("SubHeader2", "Levels of Detail");
        }
    }
}
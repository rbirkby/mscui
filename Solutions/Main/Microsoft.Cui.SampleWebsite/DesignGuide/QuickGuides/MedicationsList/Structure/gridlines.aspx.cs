// <copyright file="gridlines.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Structure Gridlines Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Structure
{
    ...
    /// <summary>
    /// QIG MedicationsList Structure Gridlines Page.
    /// </summary>
    public partial class Gridlines : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Structure/gridlines.aspx");
            Master.Attributes.Add("SubHeader1", "Structure and Layout");
            Master.Attributes.Add("SubHeader2", "Gridlines");
        }
    }
}
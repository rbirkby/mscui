// <copyright file="listlength.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Structure ListLength Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Structure
{
    ...
    /// <summary>
    /// QIG MedicationsList Structure ListLength Page.
    /// </summary>
    public partial class ListLength : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Structure/listlength.aspx");
            Master.Attributes.Add("SubHeader1", "Structure and Layout");
            Master.Attributes.Add("SubHeader2", "List Length");
        }
    }
}
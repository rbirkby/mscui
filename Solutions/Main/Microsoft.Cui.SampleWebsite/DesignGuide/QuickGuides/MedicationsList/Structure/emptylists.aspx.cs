// <copyright file="emptylists.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Structure Emptylists Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Structure
{
    ...
    /// <summary>
    /// QIG MedicationsList Structure Emptylists Page.
    /// </summary>
    public partial class EmptyLists : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Structure/emptylists.aspx");
            Master.Attributes.Add("SubHeader1", "Structure and Layout");
            Master.Attributes.Add("SubHeader2", "Empty Lists");
        }
    }
}
// <copyright file="mandatory.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Columns Mandatory Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Columns
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList Columns Mandatory Page.
    /// </summary>
    public partial class MandatoryPage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Columns/mandatory.aspx");
            Master.Attributes.Add("SubHeader1", "Columns");
            Master.Attributes.Add("SubHeader2", "Mandatory Columns");
        }
    }
}
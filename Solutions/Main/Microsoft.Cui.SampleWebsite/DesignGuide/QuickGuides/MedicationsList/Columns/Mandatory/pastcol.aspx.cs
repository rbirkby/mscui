// <copyright file="pastcol.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Columns Mandatory Pastcol Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Columns.Mandatory
{
    ...
    /// <summary>
    /// QIG MedicationsList Columns Mandatory Pastcol Page.
    /// </summary>
    public partial class PastCol : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Columns/Mandatory/pastcol.aspx");
            Master.Attributes.Add("SubHeader1", "Columns");
            Master.Attributes.Add("SubHeader2", "Mandatory Columns - Past Medications");
        }
    }
}
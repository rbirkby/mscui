// <copyright file="currentcol.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Columns Mandatory Currentcol Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Columns.Mandatory
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList Columns Mandatory Currentcol Page.
    /// </summary>
    public partial class CurrentCol : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Columns/Mandatory/currentcol.aspx");
            Master.Attributes.Add("SubHeader1", "Columns");
            Master.Attributes.Add("SubHeader2", "Mandatory Columns - Current Medications");
        }
    }
}
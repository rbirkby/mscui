// <copyright file="date.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Columns Date Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Columns
{
    ...
    /// <summary>
    /// QIG MedicationsList Columns Date Page.
    /// </summary>
    public partial class Date : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Columns/date.aspx");
            Master.Attributes.Add("SubHeader1", "Columns");
            Master.Attributes.Add("SubHeader2", "Date");
        }
    }
}
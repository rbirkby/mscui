// <copyright file="composite.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Columns Composite Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Columns
{
    ...
    /// <summary>
    /// QIG MedicationsList Columns Composite Page.
    /// </summary>
    public partial class Composite : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Columns/composite.aspx");           
            Master.Attributes.Add("SubHeader1", "Columns");
            Master.Attributes.Add("SubHeader2", "Composite");
        }
    }
}
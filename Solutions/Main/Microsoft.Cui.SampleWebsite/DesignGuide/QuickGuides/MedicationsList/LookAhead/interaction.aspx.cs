// <copyright file="interaction.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LookAhead Interaction Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.LookAhead
{
    ...
    /// <summary>
    /// QIG MedicationsList LookAhead Interaction Page.
    /// </summary>
    public partial class Interaction : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/LookAhead/interaction.aspx");
            Master.Attributes.Add("SubHeader1", "Look-Ahead Scroll Bar");
            Master.Attributes.Add("SubHeader2", "Interaction");
        }
    }
}
// <copyright file="notifications.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LookAhead Notifications Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.LookAhead
{
    ...
    /// <summary>
    /// QIG MedicationsList LookAhead Notifications Page.
    /// </summary>
    public partial class NotificationsPage : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/LookAhead/notifications.aspx");
            Master.Attributes.Add("SubHeader1", "Look-Ahead Scroll Bar");
            Master.Attributes.Add("SubHeader2", "Notifications");
        }
    }
}
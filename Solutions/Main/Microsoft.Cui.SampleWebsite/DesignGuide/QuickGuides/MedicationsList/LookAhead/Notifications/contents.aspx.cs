// <copyright file="contents.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LookAhead Notifications Contents Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.LookAhead.Notifications
{
    ...
    /// <summary>
    /// QIG MedicationsList LookAhead Notifications Contents Page.
    /// </summary>
    public partial class Contents : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/LookAhead/Notifications/contents.aspx");
            Master.Attributes.Add("SubHeader1", "Look-Ahead Scroll Bar");
            Master.Attributes.Add("SubHeader2", "Notifications - Contents");
        }
    }
}
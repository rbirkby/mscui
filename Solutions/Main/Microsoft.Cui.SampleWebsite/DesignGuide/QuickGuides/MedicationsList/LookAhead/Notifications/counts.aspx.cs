// <copyright file="counts.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LookAhead Notifications Counts Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.LookAhead.Notifications
{
    ...
    /// <summary>
    /// QIG MedicationsList LookAhead Notifications Counts Page.
    /// </summary>
    public partial class Counts : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/LookAhead/Notifications/counts.aspx");
            Master.Attributes.Add("SubHeader1", "Look-Ahead Scroll Bar");
            Master.Attributes.Add("SubHeader2", "Notifications - Counts");
        }
    }
}
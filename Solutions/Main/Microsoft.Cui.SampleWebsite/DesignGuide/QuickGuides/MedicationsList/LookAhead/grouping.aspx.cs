// <copyright file="grouping.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList LookAhead Grouping Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.LookAhead
{
    ...
    /// <summary>
    /// QIG MedicationsList LookAhead Grouping Page.
    /// </summary>
    public partial class Grouping : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/LookAhead/grouping.aspx");
            Master.Attributes.Add("SubHeader1", "Look-Ahead Scroll Bar");
            Master.Attributes.Add("SubHeader2", "Grouping");
        }
    }
}
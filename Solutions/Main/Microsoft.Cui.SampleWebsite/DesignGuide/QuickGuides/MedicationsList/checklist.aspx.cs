// <copyright file="checklist.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList CheckList Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList
{
    ...
    /// <summary>
    /// QIG MedicationsList CheckList Page.
    /// </summary>
    public partial class CheckList : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/checklist.aspx");
            Master.Attributes.Add("SubHeader1", "Checklist");
            Master.Attributes.Add("SubHeader2", "Full List of Guidance Points");
        }
    }
}
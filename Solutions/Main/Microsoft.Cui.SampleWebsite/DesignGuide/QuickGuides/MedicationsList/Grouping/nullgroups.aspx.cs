// <copyright file="nullgroups.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Grouping NullGroups Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Grouping
{
    ...
    /// <summary>
    /// QIG MedicationsList Grouping NullGroups Page.
    /// </summary>
    public partial class NullGroups : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Grouping/nullgroups.aspx");
            Master.Attributes.Add("SubHeader1", "Grouping");
            Master.Attributes.Add("SubHeader2", "Null Groups");
        }
    }
}
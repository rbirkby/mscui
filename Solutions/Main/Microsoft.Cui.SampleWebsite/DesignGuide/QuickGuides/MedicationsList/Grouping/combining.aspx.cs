// <copyright file="combining.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Grouping Combining Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Grouping
{
    ...
    /// <summary>
    /// QIG MedicationsList Grouping Combining Page.
    /// </summary>
    public partial class Combining : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Grouping/combining.aspx");
            Master.Attributes.Add("SubHeader1", "Grouping");
            Master.Attributes.Add("SubHeader2", "Combining");
        }
    }
}
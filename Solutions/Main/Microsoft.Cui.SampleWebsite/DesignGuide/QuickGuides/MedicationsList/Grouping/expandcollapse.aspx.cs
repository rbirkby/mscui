// <copyright file="expandcollapse.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Grouping ExpandCollapse Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Grouping
{
    ...
    /// <summary>
    /// QIG MedicationsList Grouping ExpandCollapse Page.
    /// </summary>
    public partial class ExpandCollapse : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Grouping/expandcollapse.aspx");
            Master.Attributes.Add("SubHeader1", "Grouping");
            Master.Attributes.Add("SubHeader2", "Expand and Collapse");
        }
    }
}
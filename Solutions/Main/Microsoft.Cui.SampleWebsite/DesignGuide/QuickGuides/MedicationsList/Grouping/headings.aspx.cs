// <copyright file="headings.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Grouping Headings Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Grouping
{
    ...
    /// <summary>
    /// QIG MedicationsList Grouping Headings Page.
    /// </summary>
    public partial class Headings : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Grouping/headings.aspx");
            Master.Attributes.Add("SubHeader1", "Grouping");
            Master.Attributes.Add("SubHeader2", "Headings");
        }
    }
}
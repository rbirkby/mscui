// <copyright file="rowshading.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Grouping RowShading Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Grouping
{
    ...
    /// <summary>
    /// QIG MedicationsList Grouping RowShading Page.
    /// </summary>
    public partial class RowShading : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Grouping/rowshading.aspx");
            Master.Attributes.Add("SubHeader1", "Grouping");
            Master.Attributes.Add("SubHeader2", "Row Shading");
        }
    }
}
// <copyright file="currentpaststatus.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Status Currentpaststatus Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Status
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList Status Currentpaststatus Page.
    /// </summary>
    public partial class CurrentPastStatus : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Status/currentpaststatus.aspx");
            Master.Attributes.Add("SubHeader1", "Status");
            Master.Attributes.Add("SubHeader2", "Current and Past");
        }
    }
}
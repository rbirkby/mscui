...
// <summary>QIG MedicationsList Status Formatting Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Status
{
    ...
    /// <summary>
    /// QIG MedicationsList Status Formatting Page.
    /// </summary>
    public partial class Formatting : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Status/formatting.aspx");
            Master.Attributes.Add("SubHeader1", "Status");
            Master.Attributes.Add("SubHeader2", "Formatting");
        }
    }
}
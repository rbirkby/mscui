// <copyright file="additionalinfo.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Status AdditionalInfo Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Status
{
    ...
    /// <summary>
    /// QIG MedicationsList Status AdditionalInfo Page.
    /// </summary>
    public partial class AdditionalInfo : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Status/additionalinfo.aspx");
            Master.Attributes.Add("SubHeader1", "Status");
            Master.Attributes.Add("SubHeader2", "Additional Information");
        }
    }
}
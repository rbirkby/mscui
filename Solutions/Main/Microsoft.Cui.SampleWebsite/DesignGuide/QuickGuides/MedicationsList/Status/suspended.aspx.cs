// <copyright file="suspended.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Status Suspended Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Status
{
    ...
    /// <summary>
    /// QIG MedicationsList Status Suspended Page.
    /// </summary>
    public partial class Suspended : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Status/suspended.aspx");
            Master.Attributes.Add("SubHeader1", "Status");
            Master.Attributes.Add("SubHeader2", "Suspended");
        }
    }
}
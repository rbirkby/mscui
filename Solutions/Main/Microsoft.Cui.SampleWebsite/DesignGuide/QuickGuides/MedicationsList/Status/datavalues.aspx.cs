// <copyright file="datavalues.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Status Datavalues Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Status
{
    ...
    /// <summary>
    /// QIG MedicationsList Status Datavalues Page.
    /// </summary>
    public partial class DataValues : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Status/datavalues.aspx");
            Master.Attributes.Add("SubHeader1", "Status");
            Master.Attributes.Add("SubHeader2", "Data Values");
        }
    }
}
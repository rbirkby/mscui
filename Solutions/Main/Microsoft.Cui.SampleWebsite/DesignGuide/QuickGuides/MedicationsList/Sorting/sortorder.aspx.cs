// <copyright file="sortorder.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Sorting SortOrder Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Sorting
{
    ...
    /// <summary>
    /// QIG MedicationsList Sorting SortOrder Page.
    /// </summary>
    public partial class SortOrder : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Sorting/sortorder.aspx");
            Master.Attributes.Add("SubHeader1", "Sorting");
            Master.Attributes.Add("SubHeader2", "Sort Order");
        }
    }
}
// <copyright file="sortingcontrol.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG MedicationsList Sorting SortingControl Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.MedicationsList.Sorting
{
    #region Using...
    ...
    /// <summary>
    /// QIG MedicationsList Sorting SortingControl Page.
    /// </summary>
    public partial class SortingControl : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/MedicationsList/Sorting/sortingcontrol.aspx");
            Master.Attributes.Add("SubHeader1", "Sorting");
            Master.Attributes.Add("SubHeader2", "Sorting Control");
        }
    }
}
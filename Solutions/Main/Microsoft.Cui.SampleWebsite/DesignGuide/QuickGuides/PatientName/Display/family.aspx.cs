// <copyright file="family.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Display Family Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Display
{
    ...
    /// <summary>
    /// QIG PatientName Display Family Page.
    /// </summary>
    public partial class Family : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Display/family.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Family Name");
        }
    }
}
// <copyright file="multiplecomponents.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Display GivenName MultipleNameComponents Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Display
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientName Display MultipleComponents Page.
    /// </summary>
    public partial class MultipleComponents : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Display/multiplecomponents.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Multiple Components");
        }
    }
}
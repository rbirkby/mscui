// <copyright file="given.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Display Given Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Display
{
    ...
    /// <summary>
    /// QIG PatientName Display Given Page.
    /// </summary>
    public partial class Given : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Display/given.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Given Name");
        }
    }
}
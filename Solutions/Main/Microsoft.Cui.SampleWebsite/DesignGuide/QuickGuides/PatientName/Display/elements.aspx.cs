...
// <summary>QIG PatientName Display Elements Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Display
{
    ...
    /// <summary>
    /// QIG PatientName Display Elements Page.
    /// </summary>
    public partial class Elements : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Display/elements.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Elements");
        }
    }
}
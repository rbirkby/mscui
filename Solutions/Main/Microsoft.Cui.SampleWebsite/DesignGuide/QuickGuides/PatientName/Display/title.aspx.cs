// <copyright file="title.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Display Title Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Display
{
    ...
    /// <summary>
    /// QIG PatientName Display Title Page.
    /// </summary>
    public partial class Title : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Display/title.aspx");
            Master.Attributes.Add("SubHeader1", "Display");
            Master.Attributes.Add("SubHeader2", "Title");
        }
    }
}
...
// <summary>QIG PatientName Input Instructions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input
{
    ...
    /// <summary>
    /// QIG PatientName Input Instructions Page.
    /// </summary>
    public partial class InstructionsPage : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/instructions.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Instructional Text");
        }
    }
}
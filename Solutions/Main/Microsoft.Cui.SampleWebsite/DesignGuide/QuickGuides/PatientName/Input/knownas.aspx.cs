// <copyright file="knownas.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input KnownAs Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientName Input KnownAs Page.
    /// </summary>
    public partial class KnownAs : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/knownas.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Known As");
        }
    }
}
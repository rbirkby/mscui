// <copyright file="tooltips.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input Instructions Tooltips Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input.Instructions
{
    ...
    /// <summary>
    /// QIG PatientName Input Instructions Tooltips Page.
    /// </summary>
    public partial class ToolTips : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/Instructions/tooltips.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Instructional Text - Tooltips");
        }
    }
}
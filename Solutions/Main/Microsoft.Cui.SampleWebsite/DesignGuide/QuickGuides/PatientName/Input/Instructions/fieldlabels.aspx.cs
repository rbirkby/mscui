// <copyright file="fieldlabels.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input Instructions FieldLabels Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input.Instructions
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientName Input Instructions FieldLabels Page.
    /// </summary>
    public partial class FieldLabels : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/Instructions/fieldlabels.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Instructional Text - Field Labels");
        }
    }
}
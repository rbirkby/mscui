// <copyright file="prompts.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input Instructions Prompts Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input.Instructions
{
    ...
    /// <summary>
    /// QIG PatientName Input Instructions Prompts Page.
    /// </summary>
    public partial class Prompts : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/Instructions/prompts.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Instructional Text - Prompts");
        }
    }
}
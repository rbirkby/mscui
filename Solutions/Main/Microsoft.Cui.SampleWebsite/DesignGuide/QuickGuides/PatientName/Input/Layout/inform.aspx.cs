// <copyright file="inform.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input Layout Inform Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input.Layout
{
    ...
    /// <summary>
    /// QIG PatientName Input Layout Inform Page.
    /// </summary>
    public partial class InForm : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/Layout/inform.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Control Layouts - In-Form");
        }
    }
}
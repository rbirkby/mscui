// <copyright file="inline.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG PatientName Input Layout InLine Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.PatientName.Input.Layout
{
    #region Using...
    ...
    /// <summary>
    /// QIG PatientName Input Layout InLine Page.
    /// </summary>
    public partial class InLine : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/PatientName/Input/Layout/inline.aspx");
            Master.Attributes.Add("SubHeader1", "Input");
            Master.Attributes.Add("SubHeader2", "Control Layouts - In-Line");
        }
    }
}
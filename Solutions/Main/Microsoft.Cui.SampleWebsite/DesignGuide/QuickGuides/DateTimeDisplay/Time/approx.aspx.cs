...
// <summary>QIG DateTimeDisplay Time Approx Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Time
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Time Approx Page.
    /// </summary>
    public partial class Approx : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Time/approx.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Approximate Times");
        }
    }
}
// <copyright file="midnight.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Time Midnight Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Time
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeDisplay Time Midnight Page.
    /// </summary>
    public partial class Midnight : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Time/midnight.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Midnight and Null Values");
        }
    }
}
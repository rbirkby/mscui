// <copyright file="24hrclock.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Time Clock24Hr Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Time
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Time Clock24Hr Page.
    /// </summary>
    public partial class Clock24Hr : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Time/24hrclock.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "24-Hour Clock");
        }
    }
}
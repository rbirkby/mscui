// <copyright file="ranges.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Time Ranges Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Time
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Time Ranges Page.
    /// </summary>
    public partial class Ranges : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Time/ranges.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Time Ranges");
        }
    }
}
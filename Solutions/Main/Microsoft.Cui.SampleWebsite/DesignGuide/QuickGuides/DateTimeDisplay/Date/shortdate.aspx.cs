// <copyright file="shortdate.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date ShortDate Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date ShortDate Page.
    /// </summary>
    public partial class ShortDatePage : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/shortdate.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Short Date Format");
        }
    }
}
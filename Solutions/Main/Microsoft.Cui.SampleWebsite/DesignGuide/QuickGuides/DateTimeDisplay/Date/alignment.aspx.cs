// <copyright file="alignment.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date Alignment Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date Alignment Page.
    /// </summary>
    public partial class Alignment : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/alignment.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Alignment");
        }
    }
}
// <copyright file="year.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date Year Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date Year Page.
    /// </summary>
    public partial class Year : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/year.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Year");
        }
    }
}
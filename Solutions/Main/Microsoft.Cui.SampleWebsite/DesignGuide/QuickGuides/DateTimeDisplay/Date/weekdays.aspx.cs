// <copyright file="weekdays.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date WeekDays Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date WeekDays Page.
    /// </summary>
    public partial class WeekDays : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/weekdays.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Days of the Week");
        }
    }
}
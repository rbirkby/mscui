// <copyright file="daymonth.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date ShortDate DayMonth Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date.ShortDate
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date ShortDate DayMonth Page.
    /// </summary>
    public partial class DayMonth : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/ShortDate/daymonth.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Short Date Format - Day and Month");
        }
    }
}
// <copyright file="separators.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Date ShortDate Separators Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date.ShortDate
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date ShortDate Separators Page.
    /// </summary>
    public partial class Separators : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/ShortDate/separators.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Short Date Format - Separators");
        }
    }
}
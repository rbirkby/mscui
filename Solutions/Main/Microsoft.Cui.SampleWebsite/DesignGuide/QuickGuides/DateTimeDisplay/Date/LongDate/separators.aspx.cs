...
// <summary>QIG DateTimeDisplay Date LongDate Separators Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date.LongDate
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date LongDate Separators Page.
    /// </summary>
    public partial class Separators : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/LongDate/separators.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Long Date Format - Separators");
        }
    }
}
...
// <summary>QIG DateTimeDisplay Date LongDate DayMonth Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Date.LongDate
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Date LonDate DayMonth Page.
    /// </summary>
    public partial class DayMonth : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Date/LongDate/daymonth.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Long Date Format - Day and Month");
        }
    }
}
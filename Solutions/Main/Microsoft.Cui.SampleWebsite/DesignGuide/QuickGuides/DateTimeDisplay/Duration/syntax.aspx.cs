// <copyright file="syntax.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Duration Syntax Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Duration Syntax Page.
    /// </summary>
    public partial class Syntax : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Duration/syntax.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Syntax");
        }
    }
}
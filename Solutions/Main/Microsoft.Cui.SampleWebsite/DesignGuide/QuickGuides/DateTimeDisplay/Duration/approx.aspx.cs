// <copyright file="approx.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Duration Approx Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeDisplay Duration Approx Page.
    /// </summary>
    public partial class Approx : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Duration/approx.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Approximate Duration");
        }
    }
}
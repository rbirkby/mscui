// <copyright file="abbreviations.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeDisplay Duration Abbreviations Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeDisplay.Duration
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeDisplay Duration Abbreviations Page.
    /// </summary>
    public partial class Abbreviations : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeDisplay/Duration/abbreviations.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Abbreviations");
        }
    }
}
// <copyright file="disambiguation.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Duration Disambiguation Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Duration
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput Duration Disambiguation Page.
    /// </summary>
    public partial class Disambiguation : System.Web.UI.Page
    {
        /// <summary>
        /// Page load method.
        /// </summary>
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Duration/disambiguation.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Disambiguation");
        }
    }
}
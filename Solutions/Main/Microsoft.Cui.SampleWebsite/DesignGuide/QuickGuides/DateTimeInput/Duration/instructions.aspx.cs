...
// <summary>QIG DateTimeInput Duration Instructions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeInput Duration Instructions Page.
    /// </summary>
    public partial class Instructions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Duration/instructions.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Instructions");
        }
    }
}
...
// <summary>QIG DateTimeInput Duration Editing Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeInput Duration Editing Page.
    /// </summary>
    public partial class Editing : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Duration/editing.aspx"); 
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Editing");
        }
    }
}
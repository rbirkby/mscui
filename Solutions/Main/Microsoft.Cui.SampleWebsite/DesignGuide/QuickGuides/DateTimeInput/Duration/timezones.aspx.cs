// <copyright file="timezones.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Duration TimeZones Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeInput Duration TimeZones Page.
    /// </summary>
    public partial class TimeZones : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Duration/timezones.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Time Zones");
        }
    }
}
// <copyright file="displayformat.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Duration DisplayFormat Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Duration
{
    ...
    /// <summary>
    /// QIG DateTimeInput Duration DisplayFormat Page.
    /// </summary>
    public partial class DisplayFormat : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Duration/displayformat.aspx");
            Master.Attributes.Add("SubHeader1", "Duration");
            Master.Attributes.Add("SubHeader2", "Display Format");
        }
    }
}
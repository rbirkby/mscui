// <copyright file="elements.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Date CalInput Elements Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.CalInput
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date CalInput Elements Page.
    /// </summary>
    public partial class Elements : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/CalInput/elements.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Calendar Entry - Elements");
        }
    }
}

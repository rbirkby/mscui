// <copyright file="keyboard.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Date CalInput Keyboard Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.CalInput
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date CalInput Keyboard Page.
    /// </summary>
    public partial class Keyboard : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/CalInput/keyboard.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Calendar Entry - Keyboard");
        }
    }
}

...
// <summary>QIG DateTimeInput Date CalInput Editing Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.CalInput
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date CalInput Editing Page.
    /// </summary>
    public partial class Editing : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/CalInput/editing.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Calendar Entry - Editing"); 
        }
    }
}
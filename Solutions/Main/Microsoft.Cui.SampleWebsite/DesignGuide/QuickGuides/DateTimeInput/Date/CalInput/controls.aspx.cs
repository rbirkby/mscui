...
// <summary>QIG DateTimeInput Date CalInput Controls Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.CalInput
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date CalInput Controls Page.
    /// </summary>
    public partial class Controls : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/CalInput/controls.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Calendar Entry - Calendar Controls");
        }
    }
}

...
// <summary>QIG DateTimeInput Date CalInput Instructions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.CalInput
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput Date CalInput Instructions Page.
    /// </summary>
    public partial class Instructions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/CalInput/instructions.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Calendar Entry - Instructions");
        }
    }
}

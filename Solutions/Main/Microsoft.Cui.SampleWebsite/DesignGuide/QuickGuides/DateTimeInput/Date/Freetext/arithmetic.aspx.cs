// <copyright file="arithmetic.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Date Freetext Arithmetic Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.Freetext
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date Freetext Editing Page.
    /// </summary>
    public partial class Arithmetic : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/Freetext/arithmetic.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Free Text Entry - Arithmetic Shortcuts");
        }
    }
}
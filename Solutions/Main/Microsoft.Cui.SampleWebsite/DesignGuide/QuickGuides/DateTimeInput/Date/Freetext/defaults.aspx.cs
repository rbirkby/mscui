...
// <summary>QIG DateTimeInput Date Freetext Defaults Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.Freetext
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date Defaults Editing Page.
    /// </summary>
    public partial class Defaults : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/Freetext/defaults.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Free Text Entry - Defaults");
        }
    }
}
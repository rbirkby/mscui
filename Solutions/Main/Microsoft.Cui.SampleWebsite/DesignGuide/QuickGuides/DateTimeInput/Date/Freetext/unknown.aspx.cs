// <copyright file="unknown.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Date Freetext Unknown Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.Freetext
{
    ...
    /// <summary>
    /// QIG DateTimeInput Date Freetext Unknown Page.
    /// </summary>
    public partial class Unknown : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/Freetext/unknown.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Free Text Entry - Unknown Values");
        }
    }
}
// <copyright file="instructions.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Date Freetext Instructions Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Date.Freetext
{
    #region Using...
    ...
    /// <summary>
    /// QIG DateTimeInput Date Freetext Instructions Page.
    /// </summary>
    public partial class Instructions : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Date/Freetext/instructions.aspx");
            Master.Attributes.Add("SubHeader1", "Date");
            Master.Attributes.Add("SubHeader2", "Free Text Entry - Instructions");
        }
    }
}
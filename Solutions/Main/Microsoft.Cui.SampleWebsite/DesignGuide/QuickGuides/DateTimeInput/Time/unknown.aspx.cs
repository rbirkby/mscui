...
// <summary>QIG DateTimeInput Time Unknown Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Time
{
    ...
    /// <summary>
    /// QIG DateTimeInput Time Unknown Page.
    /// </summary>
    public partial class Unknown : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Time/unknown.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Unknown Values");
        }
    }
}
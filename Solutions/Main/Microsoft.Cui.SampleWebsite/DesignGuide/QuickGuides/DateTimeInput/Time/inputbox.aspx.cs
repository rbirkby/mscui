// <copyright file="inputbox.aspx.cs" company="Microsoft Corporation copyright 2010.">
...
// <summary>QIG DateTimeInput Time InputBox Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Time
{
    ...
    /// <summary>
    /// QIG DateTimeInput Time InputBox Page.
    /// </summary>
    public partial class InputBox : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Time/inputbox.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Input Box");
        }
    }
}
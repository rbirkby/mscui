...
// <summary>QIG DateTimeInput Time Arithmetic Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Time
{
    ...
    /// <summary>
    /// QIG DateTimeInput Time Arithmetic Page.
    /// </summary>
    public partial class Arithmetic : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Time/arithmetic.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Arithmetic Shortcuts");
        }
    }
}
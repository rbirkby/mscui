...
// <summary>QIG DateTimeInput Time Defaults Page.</summary>
namespace Microsoft.Cui.SampleWebsite.DesignGuide.QuickGuides.DateTimeInput.Time
{
    ...
    /// <summary>
    /// QIG DateTimeInput Time Defaults Page.
    /// </summary>
    public partial class Defaults : System.Web.UI.Page
    {
        ...
        {
            Master.Attributes.Add("PageHref", "QuickGuides/DateTimeInput/Time/defaults.aspx");
            Master.Attributes.Add("SubHeader1", "Time");
            Master.Attributes.Add("SubHeader2", "Defaults");
        }
    }
}
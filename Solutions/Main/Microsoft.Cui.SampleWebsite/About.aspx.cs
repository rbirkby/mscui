// <copyright file="About.aspx.cs" company="Microsoft Corporation copyright 2008.">
...
namespace Microsoft.Cui.SampleWebsite
{
    ...
    /// <summary>
    /// About web page code behind
    /// </summary>
    public partial class About : System.Web.UI.Page
    {
        /// <summary>
        /// About Page Load Method.
        /// </summary>
        /// <param name="sender">Sender of the event.</param>
        /// <param name="e">Event Argument.</param>
        protected void Page_Load(object sender, EventArgs e)
        {
            // imgBtnVideo.Attributes["TestimonialID"] = "testimonials02";
        }
    }
}
